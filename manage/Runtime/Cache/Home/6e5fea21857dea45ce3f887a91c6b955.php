	...
	<div class="col-md-7">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form role="form" class="form-horizontal" action="../messagemanage/useradd" method="post">
					<div class="form-group">
						<label class="col-sm-2 control-label" for="field-1">用户昵称</label>
						<div class="col-sm-8">
							<input type="text" name="username" class="form-control pass_change" id="field-1" placeholder="请输入用户昵称（必填）" required="required">
						</div>
					</div>
					<div class="form-group-separator"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="field-2">用户密码</label>
						<div class="col-sm-8">
							<input type="text" name="password" class="form-control pass_change" id="field-2" placeholder="请输入用户密码" value="123456">
						</div>
					</div>
					<div class="form-group-separator"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="field-3">用户电话</label>
						<div class="col-sm-8">
							<input type="text" name="number" class="form-control pass_change" id="field-3" placeholder="请输入用户电话">
						</div>
					</div>
					<div class="form-group-separator"></div>
					<div class="form-group">
					...
					<div class="form-group-separator"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="field-4">真实姓名</label>
						<div class="col-sm-8">
							<input type="text" name="username2" class="form-control pass_change" id="field-4" placeholder="请输入真实姓名（必填）" required="required">
						</div>
					</div>
					<div class="form-group-separator"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="field-5">Email</label>
						<div class="col-sm-8">
							<input type="text" name="email" class="form-control pass_change" id="field-5" placeholder="请输入Email">
						</div>
					</div>
					<div class="form-group-separator"></div>
					<div class="form-group">
