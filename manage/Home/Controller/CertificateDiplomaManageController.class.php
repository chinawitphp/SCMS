...
class CertificateDiplomaManageController extends AuthorityController {
    ...
    public function searchInfo(){
        ...
        $list=$search->join('ms_holdercomminfo ON ms_seameninfo.holderid = ms_holdercomminfo.id')->field('ms_seameninfo.id,idnumber,realname,regtime,endtime')->where($map)->select();
        $this->ajaxReturn($list);
    ...
    public function infoDetail(){
        ...
        $search = D("seameninfo");
        $infolist=$search->join('ms_holdercomminfo ON ms_seameninfo.holderid = ms_holdercomminfo.id')->field('holderid,idnumber,realname,regtime,endtime,nation,signorgid')->where($map)->select();
        //判断访问来源
        if ($_GET['type']==app){
